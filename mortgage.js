...
function calculateMortgage(loanAmount,interestRate,numberMonthlyPayments){
    function pertentageToDecimal(percent){
        return percent/12/100;
    }
    interestRate=pertentageToDecimal(interestRate);
...
function validate(){
    if(homeValue.value===""||downPayment.value===""||interestRate.value===""||loanDuration.value==="")
    {
